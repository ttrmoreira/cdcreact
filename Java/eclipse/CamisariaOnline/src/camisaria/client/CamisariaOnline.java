package camisaria.client;

import camisaria.shared.FieldVerifier;
 ...
 */
public class CamisariaOnline implements EntryPoint {
	/**
...
//		rootPanel.add(deckPanel, 10, 84);
		deckPanel.setSize("430px", "171px");
		deckPanel.setStyleName("deckpanel");
	      // Create lables to add to deckpanel
	      Label label1 = new Label("Escolha sua camisa");
	      Label label2 = new Label("Escolhas as medidas");
	      Label label3 = new Label("Escolha a forma de pagamento");
